...
/*
	...
	void test_operator_overloading() {
		...
		test_1.insert_artwork(test_v[0]);
		test_1.insert_artwork(test_v[1]);
		assert(test_1.sell_artwork(test_vals[1]));
		//cout<< "Test8: sell_artwork passed" << endl;
		
		test_2.insert_artwork(test_v[0]);
		test_2.insert_artwork(test_v[1]);
		assert(test_2.sell_artwork(test_vals[0]));
		//cout << "lols worked" << endl;
		
		test_3.insert_artwork(test_v[0]);
		
		test_4.insert_artwork(test_v[1]);
